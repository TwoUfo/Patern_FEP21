...
with open("D:\\University\\2 course\\Semester 1\\Design patterns\\Lab2\\input.json", "w") as outfile:
    outfile.write(json_object)

containers = [BasicContainer(250), BasicContainer(450), HeavyContainer(350), RefrigeratedContainer(250.5),
              LiquidContainer(124)]
ports = [PortClass(
