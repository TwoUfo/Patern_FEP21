...
def main():
    operator1 = OperatorClass(0, 'Abraham', 0.1, 0.5, 0.3, 0.7)
    operator2 = OperatorClass(1, 'Abdulah', 1.3, 0.4, 0.1, 0.7)

    bill1 = BillClass(150, 0)
    bill2 = BillClass(300, 1)

    customer1 = CustomerClass(0, 'Muhamed', 19, operator1,
                              bill1, 150)
    customer2 = CustomerClass(1, 'Kozinyy', 28, operator2,
                              bill2, 300)
